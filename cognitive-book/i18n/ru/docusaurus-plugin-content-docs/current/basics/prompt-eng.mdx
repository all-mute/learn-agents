...
1. Идем сюда https://www.promptingguide.ai/ и читаем все главы до Chain of Thought включительно с самой первой.

    {/* LOCAL TEXT START */}
    - (ru) https://www.promptingguide.ai/ru - перевод среднего качества
    {/* LOCAL TEXT END */}
