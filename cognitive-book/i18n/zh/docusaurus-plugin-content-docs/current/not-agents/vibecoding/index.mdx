...
在这一阶段，我们将学习一种革命性的编程方法——vibe-coding（氛围编程），并了解 Cursor AI，它是一种使用人工智能生成代码的工具。您将学习如何应用这些技术来显著加速开发过程，并在没有深入编程语言知识的情况下创建应用程序。
...
Vibe-coding（氛围编程）是由研究员 Andrei Karpathy 提出的一种创新的软件开发方法。这种方法完全重新定义了编程过程：开发人员用自然语言表达他们的意图，并允许人工智能生成大部分实际代码[^1]。

:::warning

**Vibe-coding 不是一项简单的技能**，就像大多数人认为的那样。合理地分配与学习一门新的编程语言相同的时间来掌握它。**然而，投入到学习中的时间将获得数十倍的回报。**
...
人工智能研究员 Simon Willison 解释了一个重要的细微差别：“如果神经网络编写了你的每一行代码，但你已经检查、测试并完全理解了它——这已经不是 vibe-coding，而只是使用神经网络作为打字机”[^1]。
...
Cursor AI 是一款集成了人工智能的代码编辑器，它是实践中实现 vibe-coding 的领先工具之一。它提供了一种独特的编程方法，使应用程序的创建过程更加容易和高效[^3]。
...
[Vibecoding Guides](https://github.com/cpjet64/vibecoding) - 这些指南是由一位经验丰富的人编写的。根据 [@llm_notes](https://t.me/llm_notes) 的经验 - 使用这些指南中的建议，您将能够创建工业级的、架构复杂的 zero-shot 服务。

### E2. 如何根据昨天框架中的更改进行 vibe-coding？

基于 llm 的助手的问题在于，它们的预训练是在特定时间制作的互联网切片上完成的 - 通常这个切片比当前日期落后 10 多个月。
在这几个月里，新的框架出现了，旧的框架更新了 - 助手编写代码时并不知道这些变化。
...
我们研究了 vibe-coding 的概念，这是一种使用人工智能的革命性编程方法。我们了解了 Cursor AI——一个集成了 AI 的代码编辑器，它允许根据自然语言的描述生成代码。现在我们了解了如何安装和配置 Cursor AI，如何与它交互以及如何制定代码生成请求。

## Exercises

1. **分析和反思**：思考一下，在人工智能编写大部分代码的世界里，程序员的角色会发生怎样的变化？哪些技能会变得更有价值，哪些技能会变得不那么受欢迎？

<details>
<summary>答案</summary>

https://youtu.be/psLjf6xeaj0?si=VTnLEcGEcff98jHb
大约从 6:30 到 26:00 - 深刻的思考
...
4. 尝试为你的想法编写 PRD - 然后使用昂贵的 ChatGPT 改进它 - 然后阅读她的 PRD 并编辑它
5. 对生活有益 - 要求代理“使用 python 和 seaborn 库为你制作一些图表”
