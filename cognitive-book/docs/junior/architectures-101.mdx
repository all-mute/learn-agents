...
Hooray! Starting with this module, we will be studying agents! Previously, you have already familiarized yourself with how to create AI Workflows without loops, and in the HF course, you learned about the basic elements (LLM, Tool, Context) that an agent consists of. Now we will look at agent architectures - with loops.
...
In this module, we got acquainted with the basics of cognitive architectures for AI Agents, and examined their main types:
- Reflection
- Reflexion Actor
- Plan-and-Execute
- ReWoo
...
Next, we will delve into the **practical aspects** of agent development. You will learn about more advanced architectures in the Senior & Frontier blocks.
