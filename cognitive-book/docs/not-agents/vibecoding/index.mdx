...
### 1.3. Introduction to Cursor AI as a vibe-coding tool
...
2. After installation, you will see an interface similar to Visual Studio Code, but with additional AI functions
...
5. Formulate a request to generate code[^3]
...
[Vibecoding Guides](https://github.com/cpjet64/vibecoding) - these guides are written by a person with extensive experience. According to the experience of [@llm_notes](https://t.me/llm_notes) - using the tips from these guides, you can create architecturally complex services zero-shot.
...
- https://github.com/roboco-io/awesome-vibecoding?tab=readme-ov-file - a list of everything in a row on vibe-coding
...
4. Try writing a PRD for your idea - then improve it with expensive ChatGPT - then read her PRD and edit it
